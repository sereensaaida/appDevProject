...
//
//   Future<void> _fetchLocations(search) async {
//     var response = await http.get(Uri.parse(
//         "https://api.geoapify.com/v1/geocode/autocomplete?text=montre&apiKey=64e26f926c7f4a18b39b30330b9fb634"));
...
//           Container(
//               padding:
//                   EdgeInsets.only(top: 10, left: 55, right: 55, bottom: 10),
//               child:
//               // TextField(
